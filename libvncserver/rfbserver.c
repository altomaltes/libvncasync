...
static void rfbProcessClientProtocolVersion( rfbClientPtr );
static void rfbProcessClientNormalMessage(   rfbClientPtr );
static void rfbProcessClientInitMessage(     rfbClientPtr );
    ...
    { if ( !getStreamBytes( cl, sz_rfbSetEncodingsMsg-1 )) return;
      ...
      cl->enableServerIdentity     = FALSE;
        ...
        enc= *encPtr; enc= Swap32IfLE( enc );
            ...
            case rfbEncodingCopyRect:     		cl->useCopyRect = TRUE;            break;
            case rfbEncodingRaw:
            case rfbEncodingRRE:
